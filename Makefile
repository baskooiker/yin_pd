...
ALL_CFLAGS = -I"$(PD_INCLUDE)" -I"../utils" -I"../YIN"
ALL_LDFLAGS =  
SHARED_LDFLAGS =
ALL_LIBS = 
...
../YIN/YIN.o: ../YIN/YIN.cpp
	$(CC) $(ALL_CFLAGS) -o "../YIN/YIN.o" -c "../YIN/YIN.cpp"

../utils/HistogramBuffer.o: ../utils/HistogramBuffer.cpp
	$(CC) $(ALL_CFLAGS) -o "../utils/HistogramBuffer.o" -c "../utils/HistogramBuffer.cpp"

%.o: %.c
	$(CC) $(ALL_CFLAGS) -o "$*.o" -c "$*.c"

%.$(EXTENSION): ../YIN/YIN.o ../utils/HistogramBuffer.o %.o $(SHARED_LIB)
	$(CC) $(ALL_LDFLAGS) -o "$*.$(EXTENSION)"  "$*.o" "../Yin/Yin.o" "../utils/HistogramBuffer.o"  $(ALL_LIBS) $(SHARED_LIB)
	chmod a-x "$*.$(EXTENSION)"
