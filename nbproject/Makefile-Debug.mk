...
${OBJECTDIR}/_ext/1360910959/YIN.o: ../YIN/YIN.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360910959/YIN.o ../YIN/YIN.cpp

${OBJECTDIR}/_ext/1360910959/main.o: ../YIN/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1360910959
	${RM} $@.d
	$(COMPILE.cc) -g  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1360910959/main.o ../YIN/main.cpp

${OBJECTDIR}/_ext/2102424670/AlphaFilter.o: ../utils/AlphaFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2102424670
	${RM} $@.d
	$(COMPILE.cc) -g  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2102424670/AlphaFilter.o ../utils/AlphaFilter.cpp

${OBJECTDIR}/_ext/2102424670/HistogramBuffer.o: ../utils/HistogramBuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2102424670
	${RM} $@.d
	$(COMPILE.cc) -g  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2102424670/HistogramBuffer.o ../utils/HistogramBuffer.cpp

${OBJECTDIR}/_ext/2102424670/utils.o: ../utils/utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/2102424670
	${RM} $@.d
	$(COMPILE.cc) -g  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2102424670/utils.o ../utils/utils.cpp

${OBJECTDIR}/yin.o: yin.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g  -MMD -MP -MF $@.d -o ${OBJECTDIR}/yin.o yin.cpp
